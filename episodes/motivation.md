...
Sarah Wild, in an [article for physics today](https://physicstoday.aip.org/news/irreproducible-astronomy) describes the concern many astronomers have around reprodicibility and a potential erosion of trust in science.
...
> *You are the first and most frequent reuser of your own code.*

:::: challenge

## Quick discussion

> Have you ever failed to reproduce *your own* ML result after a few months?
...
> **Reproducibility shifts risk from "who did this?" to "what does the evidence show?"**
...
The takeaway is not "do this to game citations", but:

> **Visibility and reuse tend to follow clarity and accessibility.**
...
> *"Reproducible research is not about being perfect, it's about making your future life easier."”"*